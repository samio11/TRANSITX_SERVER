...
class QueryBuilder {
    ...
    filter() {
        ...
        Query_contants_1.excludingFields.forEach((x) => delete filter[x]);
    ...
    search(searchFields) {
        ...
        const searchQuery = {
            $or: searchFields === null || searchFields === void 0 ? void 0 : searchFields.map((x) => ({ $regex: searchTerm, $options: "i" })),
        };
    ...
    fields() {
        ...
        const fields = ((_a = this === null || this === void 0 ? void 0 : this.query) === null || _a === void 0 ? void 0 : _a.fields)
            ? (_b = this.query) === null || _b === void 0 ? void 0 : _b.fields.split(",").join(" ")
            : "";
